...
class DomainNameValidator extends \Neos\Flow\Validation\Validator\AbstractValidator {
    ...
    /**
     * Array of all allowed top level domains, defined by IANA
     *
     ...
     * @var array
     */
    protected $allowedTopLevelDomains = array(
        'aaa',
        'aarp',
        'abarth',
        'abb',
    ...
    protected function isValid($domainName) {
        ...
        if (
            ...
            && $this->checkForValidTopLevelDomain()
        ) {
    ...
    /**
     * Checks the last segment of the domain name to be a valid value from the IANA list of
     * allowed top-level-domains.
     *
     * @return bool
     */
    private function checkForValidTopLevelDomain() {
        $segments = explode(".", $this->domainNameToCheck);
        return in_array(strtolower(end($segments)), $this->allowedTopLevelDomains);
    }
}
